...
def test_opiskelijanumeroOk_kirjain():
    assert identityCheck.opiskelijanumeroOk('12A34') == False
...
# Henkilötunnuksessa pitää olla 11 merkkiä, merkkejä liian vähän
...
# Henkilötunnuksen numeroista tehdään luku, esim 130728478 ja jaetaan se luvulla 31.
# Jakojäännös on tarkiste. Jos se on alle 10, käytetään numeroa ja jos yli 10, haetaan
# taulukosta vastaaava kirjainmerkki 10 -> A, 11 -> B. G jaI eivät ole käytössä.
